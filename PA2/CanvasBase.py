...
class CanvasBase(glcanvas.GLCanvas):
    ...
    def __init__(self, parent):
        ...
        super(CanvasBase, self).__init__(parent, attribList=[glcanvas.WX_GL_DEPTH_SIZE, 24, 0])
    ...
    def OnResize(self, event):
        ...
        glu.gluPerspective(25, float(self.size[0])/self.size[1], 0.001, 100)
        glu.gluLookAt(0, 0, 12, 0, 0, 0, 0, 1, 0)  # Camera at (0, 0, 12), look at (0, 0, 0), up vector (0, 1, 0)
